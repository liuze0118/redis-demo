...
public class ILicenseCreator {
    ...
    public ILicenseCreator(License license) {
    ...
    private LicenseParam initLicenseParam() {
        Preferences preferences = Preferences.userNodeForPackage(ILicenseCreator.class);

        //设置对证书内容加密的秘钥
        CipherParam cipherParam = new DefaultCipherParam(license.getStorePass());

        KeyStoreParam privateStoreParam = new CustomKeyStoreParam(ILicenseCreator.class
